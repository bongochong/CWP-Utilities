...
sed -i -e "/0.0.0.0 www.staradvertiser.com/d" -e "/0.0.0.0 adaway.org/d" -e "/0.0.0.0 albert.apple.com/d" -e "/0.0.0.0 amazon.com/d" -e "/0.0.0.0 ap.spotify.com/d" -e "/0.0.0.0 api-staging.backup.signal.org/d" -e "/0.0.0.0 api-staging.directory.signal.org/d" -e "/0.0.0.0 api.twitter.com/d" -e "/0.0.0.0 app.link/d" -e "/0.0.0.0 appldnld.apple.com/d" -e "/0.0.0.0 apple.com/d" -e "/0.0.0.0 apresolve.spotify.com/d" -e "/0.0.0.0 bit.ly/d" -e "/0.0.0.0 bitbucket.org/d" -e "/0.0.0.0 cdn-staging.signal.org/d" -e "/0.0.0.0 cdn2-staging.signal.org/d" -e "/0.0.0.0 community.signalusers.org/d" -e "/0.0.0.0 configuration.apple.com/d" -e "/0.0.0.0 db.tt/d" -e "/0.0.0.0 dev.twitter.com/d" -e "/0.0.0.0 dropbox.com/d" -e "/0.0.0.0 dropbox.zendesk.com/d" -e "/0.0.0.0 dropboxapi.com/d" -e "/0.0.0.0 dropboxbusiness.com/d" -e "/0.0.0.0 dropboxcaptcha.com/d" -e "/0.0.0.0 dropboxforum.com/d" -e "/0.0.0.0 dropboxforums.com/d" -e "/0.0.0.0 dropboxinsiders.com/d" -e "/0.0.0.0 dropboxmail.com/d" -e "/0.0.0.0 dropboxpartners.com/d" -e "/0.0.0.0 dropboxstatic.com/d" -e "/0.0.0.0 ea.com/d" -e "/0.0.0.0 easylist.to/d" -e "/0.0.0.0 embed.spotify.com/d" -e "/0.0.0.0 get.adobe.com/d" -e "/0.0.0.0 get3.adobe.com/d" -e "/0.0.0.0 getdropbox.com/d" -e "/0.0.0.0 github.com/d" -e "/0.0.0.0 goo.gl/d" -e "/0.0.0.0 gs.apple.com/d" -e "/0.0.0.0 hostsfile.org/d" -e "/0.0.0.0 icloud.com/d" -e "/0.0.0.0 instructorledlearning.dropboxbusiness.com/d" -e "/0.0.0.0 itunes.apple.com/d" -e "/0.0.0.0 itunes.com/d" -e "/0.0.0.0 malwaredomains.com/d" -e "/0.0.0.0 medium.com/d" -e "/0.0.0.0 movies.netflix.com/d" -e "/0.0.0.0 neocities.org/d" -e "/0.0.0.0 netflix.com/d" -e "/0.0.0.0 office.com/d" -e "/0.0.0.0 onedrive.com/d" -e "/0.0.0.0 openphish.com/d" -e "/0.0.0.0 paper.dropbox.com/d" -e "/0.0.0.0 phobos.apple.com/d" -e "/0.0.0.0 pic.twitter.com/d" -e "/0.0.0.0 platform.twitter.com/d" -e "/0.0.0.0 play.spotify.com/d" -e "/0.0.0.0 plex.tv/d" -e "/0.0.0.0 search.twitter.com/d" -e "/0.0.0.0 secure.netflix.com/d" -e "/0.0.0.0 shorl.com/d" -e "/0.0.0.0 signal.art/d" -e "/0.0.0.0 signal.org/d" -e "/0.0.0.0 signalcaptchas.org/d" -e "/0.0.0.0 someonewhocares.org/d" -e "/0.0.0.0 ssl-images-amazon.com/d" -e "/0.0.0.0 ssl.reddit.com/d" -e "/0.0.0.0 storage-staging.signal.org/d" -e "/0.0.0.0 support.signal.org/d" -e "/0.0.0.0 swscan.apple.com/d" -e "/0.0.0.0 sysctl.org/d" -e "/0.0.0.0 textsecure-service-staging.whispersystems.org/d" -e "/0.0.0.0 thepiratebay.org/d" -e "/0.0.0.0 tinyurl.com/d" -e "/0.0.0.0 tomshardware.com/d" -e "/0.0.0.0 twimg.com/d" -e "/0.0.0.0 udemy.com/d" -e "/0.0.0.0 upload.twitter.com/d" -e "/0.0.0.0 userstream.twitter.com/d" -e "/0.0.0.0 whispersystems.org/d" -e "/0.0.0.0 wix.com/d" processing/hosts/uniq-hosts.final

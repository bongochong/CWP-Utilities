...
rm processing/pac/*.pac >nul 2>nul
@echo on
wget -nv -O processing/pac/1.pac "https://gist.githubusercontent.com/bongochong/5246b4c02dddc47cc2cdd2d62a7a3c85/raw/995f65b01fb57d4357526701755be7da35cb0910/MD-Immortal_Domains-Backup.txt"

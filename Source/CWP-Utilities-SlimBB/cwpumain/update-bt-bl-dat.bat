...
cd %~dp0bin
busybox rm processing/btb/level1BTdat.7z >nul 2>nul
busybox rm processing/btb/bt_level1.dat >nul 2>nul
busybox rm processing/btb/level2BTdat.7z >nul 2>nul
busybox rm processing/btb/bt_level2.dat >nul 2>nul
busybox rm processing/btb/combined-win.txt >nul 2>nul
busybox rm processing/btb/combined-win-sort.txt >nul 2>nul
@echo on
busybox wget -nv -O processing/btb/level1BTdat.7z -U "Lynx/2.8.9dev.9 libwww-FM/2.14 SSL-MM/1.4.1 GNUTLS/3.4.11" "http://list.iblocklist.com/?list=ydxerpxkpcfqjaybcssw&fileformat=dat&archiveformat=7z"
timeout 2
busybox wget -nv -O processing/btb/level2BTdat.7z -U "Lynx/2.8.9dev.9 libwww-FM/2.14 SSL-MM/1.4.1 GNUTLS/3.4.11" "http://list.iblocklist.com/?list=gyisgnzbhppbvsphucsw&fileformat=dat&archiveformat=7z"
timeout 2
cd processing\btb
...
timeout 2
cd %~dp0bin
busybox mv processing/btb/ydxerpxkpcfqjaybcssw.txt processing/btb/bt_level1.dat
busybox mv processing/btb/gyisgnzbhppbvsphucsw.txt processing/btb/bt_level2.dat

...
pause
cd %~dp0
nano WinHostsUpdater\hosts-updater-win-ipv4.bat
goto start
...
pause
cd %~dp0
nano WinHostsUpdater\hosts-updater-win-dual.bat
goto start
...
pause
cd %~dp0
nano WinPACUpdater\update-pac-win-local.bat
goto start
...
pause
cd %~dp0
nano WinIPBlockDAT\update-bt-bl-dat.bat
goto start
...
pause
cd %~dp0
nano WinIPBlockP2P\update-bt-bl-p2p.bat
goto start
